...
if __name__ == "__main__":
    x = " ava "
    palindrome1 = Palindrome(x)
    y = "hi"
    palindrome2 = Palindrome(y)

    z = "race car"
    palindrome3 = Palindrome(z)


    print(palindrome1.analysis)
    print(palindrome1._is_a_palindrome)

    print(palindrome2.analysis)
    print(palindrome2._is_a_palindrome)

    print(palindrome3.analysis)
    print(palindrome3._is_a_palindrome)
